...
本章开始到后续OpenStack章节，暂时全部以动手实操为主，部分组件的部署会涉及到少量的理论说明和配置说明，关于完整的理论知识会在后续补充完整
...
1. 节点规划
   ...
   | ---------------------- | -------------------------------------- | ----------- | ---- | ----------------- | --------------- | ---------------- |
   | 虚拟机模板             | sda/300G                               | rhel7.9     | 8G   | 192.168.31.239/24 |                 |                  |
   | 本地yum源              | sda/300G                               | rhel7.9     | 4G   | 192.168.31.239/24 |                 |                  |
   | openstack控制节点      | sda/300G                               | rhel7.9     | 8G   | 192.168.31.40/24  | 172.16.31.40/24 | 192.168.0.40/24  |
   | openstack计算/存储节点 | sda/300G、sdb/50G                      | rhel7.9     | 6G   | 192.168.31.41/24  | 172.16.31.41/24 | 192.168.0.41/24  |
   | openstack计算/存储节点 | sda/300G、sdb/50G                      | rhel7.9     | 6G   | 192.168.31.42/24  | 172.16.31.42/24 | 192.168.0.42/24  |
   | ceph存储节点           | sda/300G、sdb/100G、sdc/100G、sdd/100G | rhel7.9     | 6G   | 192.168.31.244/24 |                 | 192.168.0.244/24 |
   | ceph存储节点           | sda/300G、sdb/100G、sdc/100G、sdd/100G | rhel7.9     | 6G   | 192.168.31.245/24 |                 | 192.168.0.245/24 |
   | ceph存储节点           | sda/300G、sdb/100G、sdc/100G、sdd/100G | rhel7.9     | 6G   | 192.168.31.246/24 |                 | 192.168.0.246/24 |
